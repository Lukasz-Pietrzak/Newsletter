...
<div class="container">
    ...
    <form method="post" action="NewsletterSubscribe_code.php">


        <div class="form-group">
            <label for="email">Podaj adres e-mail:</label>
            <input type="text" class="form-control" id="email" name="email_NewsletterSubscribe_form" value="<?=
            issetSession::issetSessionM('email');
            ?>">
            <?php

            issetSession::issetSessionM('empty_email');
            issetSession::issetSessionM('uncorrect_email');
            issetSession::issetSessionM('occupied_email');
